...
(function ($) {
    ...
    $.i18n.properties = function (settings) {
    	var selectedLang = window.location.search.substring(9, window.location.search.lastIndexOf('=') + 1);
		selectedLang = selectedLang != "" ? selectedLang : "en";
		
        var defaults = {
            name: 'messages_'+ selectedLang,
        ...
        files.forEach(function (file) {
            var defaultFileName, shortFileName, fileNames;
     ...
     */
    $.i18n.prop = function (key, parameter1 /* Add parameters as function arguments as necessary  */) {
